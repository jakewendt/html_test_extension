...
* Added revalidation control from <tt>test/test_helper.rb</tt>.  ApplicationController.validate_all = true is NOT really true.  It only validates a url ONCE.  Further calls to this url go unvalidated.
tesstin
a free line
